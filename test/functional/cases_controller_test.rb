...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { active: @case.active, company_id: @case.company_id, name: @case.name, public: @case.public }
    end
  ...
  test "should update case" do
    put :update, id: @case, case: { active: @case.active, company_id: @case.company_id, name: @case.name, public: @case.public }
    assert_redirected_to case_path(assigns(:case))
  end
